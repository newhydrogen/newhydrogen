                ...
                <div class="space-y-6 block items-start justify-between">
                    <div class="max-w-[400px] md:ml-auto w-full md:mt-0 mt-12">
                        ...
                        <div class="bg-custom-gray-100 rounded-[20px] relative sm:h-56 h-52 w-full overflow-hidden border-[14px] border-custom-green-500">
                            <img src="//img.youtube.com/vi/TqdrYBnj8gY/maxresdefault.jpg" class="object-cover w-full h-full" alt="thumbnail">
                            <a href="https://www.youtube.com/watch?v=TqdrYBnj8gY" class="popup-youtube absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2">
